...
if (!isset($_SESSION['user_name'])) {
    header("Location: signin.php"); // إذا لم يكن المستخدم مسجلاً، الانتقال إلى تسجيل الدخول
    exit;
}
?>
  ...
  <body>
      ...
      <nav>
        <div class="nav__bar">
          ...
          <ul class="nav__links">
            ...
            <li class="link"><a href="signin.php">Logout</a></li>
    ...
    <section class="footer">
      ...
      <div class="footer__bar">
          <a href="mailto:samrezzi19@gmail.com" target="_blank" dir="ltr" class="footer__bar_a">Copyright &copy; samrezzi19@gmail.com</a>
      </div>
    </section>
